...
const formLogin = document.getElementById('formLogin');
    ...
    function checkStatus(){
        ...
        fetch('/status', {
            ...
            console.log(status)
            if(status.status){
                console.log(`${status.user.firstName || status.user.name.givenName} is logged`)
                ...
                document.getElementById("nombreUsuario").innerHTML = status.user.firstName || status.user.name.givenName
            }else{
